...
export const Icon = {
  commit: (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <path d="M12 1.5v6M12 16.5v6" strokeLinecap="round"/>
    </svg>
  ),
  pr: (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <circle cx="6" cy="6" r="2.5"/><circle cx="6" cy="18" r="2.5"/><circle cx="18" cy="18" r="2.5"/>
      <path d="M6 8.5v7M18 15.5V12a3 3 0 0 0-3-3h-3l2.2-2.2M11 9l2.2 2.2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  ),
  issue: (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  people: (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <path d="M3.5 19a5.5 5.5 0 0 1 11 0M16 6.2a3.2 3.2 0 0 1 0 6M17.5 13.4a5.5 5.5 0 0 1 3 5.6" strokeLinecap="round"/>
    </svg>
  ),
  search: (
  ...
  star: (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
      <path d="m12 2 2.9 6.3 6.9.7-5.1 4.6 1.4 6.8L12 17.3 5.9 20.4l1.4-6.8L2.2 9l6.9-.7z"/>
    </svg>
  ),
  lock: (
  ...
  branch: (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <path d="M6 8.5v7M18 9.5c0 4-6 2.5-6 6.5" strokeLinecap="round"/>
    </svg>
  ),
  spark: (
